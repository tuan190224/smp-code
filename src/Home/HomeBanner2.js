...
const HomeBanner2 = () => {
  ...
  useEffect(() => {
    const fetchBanner = async () => {
      try {
        ...
        setData(response.find((item) => item.bannerID == "home2").img);
      } catch (error) {
  ...
  return (
    <div className="HomeBanner Banner2">
      <div
        id="carouselExampleControlsHome2"
      ...
      >
        ...
        <button
          ...
          type="button"
          data-bs-target="#carouselExampleControlsHome2"
          data-bs-slide="prev"
        >
          <span
